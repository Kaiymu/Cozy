            ...
            else
            {
                ...
                else // using a regular loop
                {
                    ...
                    for (int t = 0; t<numberOfTriangles; t++)
                    {
                        ...
                        waterHeight[t] = Ocean.GetHeight(Time.time, worldTriangleCenter, ref undeformedPosition[t], out Vector3 deformation);
                        ...
                        waterVelocity[t] = Ocean.GetVelocity(Time.time, undeformedPosition[t], deformation, out waterTorque[t], depth);
