...
namespace StormBreakers
{
    public class BoatController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            float oceanHeight = Ocean.GetHeight(Time.time, transform.position, ref undeformedPosition, out Vector3 deformation, false);
            ...
            if (audioSource != null)
            {
                ...
                // setting the audio volume and pitch according to the propeller usage
                audioSource.volume = Mathf.Lerp(idleVolume, fullThrottleVolume, propellerUsage);
                audioSource.pitch =  Mathf.Lerp(idlePitch, fullThrottlePitch, propellerUsage) + propellerUsage*nearSurface*unloadedAdditionalPitch;
            }
            #endregion
        }
